...
public class ProjectsApp {
	...
	private void deleteProject() {
		...
		Integer projectId = getIntInput("Please enter the ID of the project you wish to delete"); 
	...
	private void updateProjectDetails() {		
	  if(Objects.isNull(curProject)) {
	    System.out.println("\nOops! No active project selected. You must select a project first before you can update it. "
	    					+ "Please choose menu option 3 to continue");
	    return;
	  }
